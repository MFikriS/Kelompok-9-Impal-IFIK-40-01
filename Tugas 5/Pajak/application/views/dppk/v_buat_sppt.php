...
<body>
	...
	<form class="form-signin" action="<?php echo base_url('proses_buat_sppt/aksi_buat'); ?>" method="post">
		<h2 class="text-center">Form Buat SPPT</h2><br/><br/>
				...
				<div class="col-md-4">
					<input type="text" id="nosppt" name="nop" class="form-control" placeholder="Masukkan Nomor SPPT disini" required autofocus><br/>
				</div></br></br></br>
				<div class="col-md-2">
				...
				<div class="col-md-4">
					<input type="text" id="idpegawai" name="nop" class="form-control" placeholder="Masukkan ID Pegawai disini" required autofocus><br/>
				</div></br></br></br>
				<div class="col-md-2">
					<label for="username">Tahun</label>
				</div>
				<div class="col-md-4">
					<input type="text" id="tahun" name="nop" class="form-control" placeholder="Masukkan tahun disini" required autofocus><br/>
				</div></br></br></br>
				<div class="col-md-2">
					<label for="username">Tanggal Jatuh Tempo</label>
				</div>
				<div class="col-md-4">
					<input type="text" id="tanggaljatuhtempo" name="tanggaljatuhtempo" class="form-control" placeholder="Masukkan tanggal jatuh tempo disini" required autofocus><br/>
				</div></br></br></br>
				<div class="col-md-2">
					<label for="username">PBB Terhutang</label>
				</div>
				<div class="col-md-4">
					<input type="text" id="pbbterhutang1" name="pbbterhutang1" class="form-control" placeholder="Otomatis keisi ambil data dari tabel Objek Pajak" required autofocus><br/>
				</div></br></br></br>
				<div class="col-md-2">
